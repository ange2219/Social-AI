  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sb-nav">
        ...
        <Link href="/create" className={ni('/create')}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        <Link href="/analytics" className={ni('/analytics')}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        <Link href="/create" className="ni" style={{ opacity: .5, cursor: 'default', pointerEvents: 'none' }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
